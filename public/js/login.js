  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".radio-lg").change(function (ev) {
    fetch("/api/libraries/get?type=".concat(ev.currentTarget.value), {
      ...
      return response.json().then(function (json) {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('#espacio').empty().trigger('change');
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#espacio").select2({
          data: json
        });
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#espacio").val(defaultLibrary).trigger('change');
      });
    });
  });
});
